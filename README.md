# Password Generator - OOP Approach
 ...
 ## How It Works
 The password generator uses the Python `random` module to generate passwords based ob user preferences. The generator is split ito three classes, each representing a different type of password generation:
